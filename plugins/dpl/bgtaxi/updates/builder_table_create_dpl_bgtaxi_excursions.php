...
class BuilderTableCreateDplBgtaxiExcursions extends Migration
{
    public function up()
    {
        Schema::create('dpl_bgtaxi_excursions', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('dpl_bgtaxi_excursions');
    }
}